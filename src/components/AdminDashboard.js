...
const AdminDashboard = () => {
  ...
  return (
    <div className="pt-4 overflow-hidden dark:bg-neutral-900 bg-gray-200 h-screen  flex flex-col">
      ...
      <p className="dark:text-white text-gray-400 text-left text-xs font-thin mb-0 -mt-2">
        April, 2024
      </p>
      <h1 className="text-left text-sm font-semibold mb-1 -mt-1">My Tasks</h1>
      ...
      <div className="overflow-x-auto mb-4 no-scrollbar">
        <div className="flex space-x-2">
          {dates.map((date) => (
            <div
              key={date}
              className={`cursor-pointer flex flex-col items-center justify-center w-10 h-14 p-2 rounded-lg ${
                selectedDate === date ? "bg-teal-400 text-white" : "bg-gray-200"
              }`}
        ...
        <div className="pt-3 flex w-full h-full flex-col space-y-2">
            ...
            {data.map((item, index) => (
              ...
              >
                ...
                <svg
                  ...
                  strokeWidth="1.5"
                  stroke="#4B5563"
                  className="absolute right-36 pb-0 bottom-1 w-4 h-4"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
          ...
          <div
            ...
            <div className=" pe-0 h-full w-1/2 px-3">
              ...
              >
                <div className="pl-3 pt-3 text-xs text-gray-500 mb-4 flex justify-between items-center">
                  <span className="font-bold max-w-1245:font-semibold max-w-1245:text-[11px]">Announcements</span>
                  <span className="text-xs font-semibold text-green-500 pr-3 cursor-pointer">
                    View All
                  </span>
                </div>
