...
function Attendence() {
  ...
  {AttendenceData.map((entry, index) => (
    ...
    >
      <div>
        <h1 className="max-w-1245:text-xl text-2xl dark:text-white text-black">{entry.date}</h1>
      ...
      <div className="ml-5 mb-1">
        ...
        <p className="text-[10px] dark:text-gray-400 text-gray-700">{entry.timeRange}</p>
