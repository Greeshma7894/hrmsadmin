  ...
  return (
      ...
      <div className="flex flex-col items-start">
        ...
        <div className="mt-3 ml-5">
          ...
          <div className="grid grid-cols-2 gap-4 text-gray-300">
            ...
            <div>
              <p className="text-gray-500 font-semibold text-xs">Date of Birth</p>
              <p className='text-xs font-bold dark:text-white text-black'>24/08/2002</p>
            </div>
            <div>
              <p className="text-gray-500 font-semibold text-xs">Blood Group</p>
            ...
            <div>
              <p className="text-gray-500 font-semibold text-xs">Marital Status</p>
              <p className='text-xs font-bold dark:text-white text-black'>Married</p>
            </div>
           
            <div>
              <p className="text-gray-500 font-semibold text-xs">Nationality</p>
              <p className='text-xs font-bold dark:text-white text-black'>(555) 123-4567</p>
            </div>
            <div>
              <p className="text-gray-500 font-semibold text-xs">Office Details</p>
    ...
    <div className=" px-2.5">
      ...
      <div className="flex justify-between mt-2.5">
        <div>
          <h1 className="text-gray-500 font-semibold text-xs">Account number</h1>
          <h1 className='text-xs font-bold dark:text-white text-black'>xxxxxxxxxx2255</h1>
        </div>
        <div>
          <h1 className="text-gray-500 font-semibold text-xs">Bank</h1>
          <h1 className='text-xs font-bold dark:text-white text-black'>State Bank of India</h1>
        </div>
      </div>
      <div className="flex justify-between mt-2.5">
        <div>
          <h1 className="text-gray-500 font-semibold text-xs">Branch</h1>
          <h1 className='text-xs font-bold dark:text-white text-black'>State Bank of India</h1>
        </div>
        <div className="pe-3">
          <h1 className="text-gray-500 font-semibold text-xs">IFSC Code</h1>
      ...
      <div className="flex justify-end pt-8 text-green-500 font-semibold text-xs">
        <h1 className='text-xs pb-4'>Download Salary Slip</h1>
      </div>
    </div>
        </div>
</div>
